...
<head>
  ...
  <title>${title}</title>
  <meta name="description" content="TypeScript control plane for prior-authorization intake, evidence routing, payer-rule pressure, and approval-safe escalation across healthcare workflows. Operator surface in the Kinetic Gain Suite." />
  ...
  <link rel="canonical" href="https://priorauth.kineticgain.com/" />
  <link rel="icon" type="image/svg+xml" href="${KG_FAVICON_DATA_URI}" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Kinetic Gain" />
  <meta property="og:title" content="${title}" />
  <meta property="og:url" content="https://priorauth.kineticgain.com/" />
  <meta property="og:description" content="TypeScript control plane for prior-authorization intake, evidence routing, payer-rule pressure, and approval-safe escalation across healthcare workflows. Operator surface in the Kinetic Gain Suite." />
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:title" content="${title}" />
  <meta name="twitter:description" content="TypeScript control plane for prior-authorization intake, evidence routing, payer-rule pressure, and approval-safe escalation across healthcare workflows. Operator surface in the Kinetic Gain Suite." />
  <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"ProfessionalService","@id":"https://priorauth.kineticgain.com/#service","name":"Kinetic Gain — TypeScript control plane for prior-authorization intake, evidence routing, payer-rule pressure, and approval-safe escalation across healthcare workflows","url":"https://priorauth.kineticgain.com/","areaServed":"United States","description":"TypeScript control plane for prior-authorization intake, evidence routing, payer-rule pressure, and approval-safe escalation across healthcare workflows. Operator surface in the Kinetic Gain Suite."},{"@type":"WebSite","@id":"https://priorauth.kineticgain.com/#website","url":"https://priorauth.kineticgain.com/","name":"TypeScript control plane for prior-authorization intake, evidence routing, payer-rule pressure, and approval-safe escalation across healthcare workflows","publisher":{"@type":"Organization","name":"Kinetic Gain LLC"}}]}</script>
  <style>${KG_STYLE01_CSS}${KG_COMPAT_CSS}</style>
</head>
<body>
  <header>
    <div class="wrap nav">
      <a class="kg-logo" href="/" aria-label="Kinetic Gain — TypeScript control plane for prior-authorization intake, evidence routing, payer-rule pressure, and approval-safe escalation across healthcare workflows">
        ${KG_MARK_SVG}
        <span class="kg-word">Kinetic Gain</span>
      </a>
      <nav class="nav-links" id="primaryNav">
        <a href="/evidence-lane">Evidence Lane</a>
        <a href="/payer-rules">Payer Rules</a>
    ...
    <div class="wrap">
      <div class="foot-top">
        <div>
          ...
          <p class="foot-tag">TypeScript control plane for prior-authorization intake, evidence routing, payer-rule pressure, and approval-safe escalation across healthcare workflows — operator surface in the Kinetic Gain Suite. Static demo data; no live calls.</p>
        </div>
        <div class="foot-cols">
          <div class="foot-col">
            <h4>Estate</h4>
          ...
          <div class="foot-col">
            ...
            <a href="/docs">Docs</a>
            <a href="/verification">Verification</a>
            <a href="https://github.com/mizcausevic-dev/prior-authorization-evidence-router">GitHub repo</a>
            <a href="https://www.linkedin.com/company/kineticgain/">LinkedIn</a>
          </div>
        </div>
      </div>
      <div class="foot-bot">
...
export function renderOverview() {
  ...
  return layout(
    ...
    <div class="card section">
      <div class="eyebrow">Product depth</div>
      <h2>Prior Authorization Evidence Router turns payer-rule ambiguity into an approval-safe decision packet.</h2>
      <p>Revenue cycle, utilization review, clinical operations, product, and executive teams get one readable view before evidence gaps, payer-rule mismatches, or deadline pressure create denial risk.</p>
      <div class="depth-grid">
        <div class="depth-card"><h4>For non-technical leaders</h4><p>Shows which approvals are exposed, what reimbursement or patient-access risk is building, and who owns the next move.</p></div>
        <div class="depth-card"><h4>For technical and ops teams</h4><p>Frames the data contract: intake cases, evidence lane, payer rules, approval posture, owners, SLA pressure, and verification gates.</p></div>
        <div class="depth-card"><h4>For GTM and product teams</h4><p>Makes the commercial story concrete: reduced denial exposure, faster packet repair, and safer embedded approval workflows without live PHI.</p></div>
      </div>
      <div class="workflow">
        <div class="step" data-step="1"><h4>Model the approval lane</h4><p>Capture case context, payer, service line, owner, urgency, and the approval audience before work spreads into spreadsheets.</p></div>
        <div class="step" data-step="2"><h4>Map rule to evidence</h4><p>Connect payer requirements to the exact packet, blocker, and proof owner needed to keep the case approval-safe.</p></div>
        <div class="step" data-step="3"><h4>Route the decision</h4><p>Escalate the highest-risk approvals with a next action leaders, operators, and customer-facing teams can all understand.</p></div>
      </div>
    </div>
    <div class="card section">
      <div class="eyebrow">What these repos have in common</div>
      <h3>Risk, owner, proof, next action.</h3>
      <div class="card-grid">
        <div class="depth-card"><h4>Risk is visible</h4><p>Every surface names the operating exposure instead of hiding behind a generic dashboard or AI label.</p></div>
        <div class="depth-card"><h4>Ownership is explicit</h4><p>Each route points to the accountable lane, role, committee, or operator group responsible for closing the gap.</p></div>
        <div class="depth-card"><h4>Proof is packaged</h4><p>Representative, synthetic data turns the product promise into a reviewable evidence packet without exposing sensitive systems.</p></div>
        <div class="depth-card"><h4>Action is board-readable</h4><p>The final output is a decision narrative: what changed, why it matters, what to do next, and what remains unresolved.</p></div>
      </div>
    </div>
