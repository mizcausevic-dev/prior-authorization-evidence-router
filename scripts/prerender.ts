 ...
 *
 * The control plane renders deterministic HTML from synthetic sample data, so we
...
import {
  ...
  summary,
  verification
} from "../src/services/priorAuthorizationService";

const OUT = join(process.cwd(), "site");

const pages: Record<string, string> = {
  "index.html": renderOverview(),
  "evidence-lane.html": renderEvidenceLane(),
  "payer-rules.html": renderPayerRules(),
...
const linkMap: Array<[string, string]> = [
  ...
  ['href="/evidence-lane"', 'href="evidence-lane.html"'],
  ['href="/payer-rules"', 'href="payer-rules.html"'],
...
const api: Record<string, unknown> = {
  ...
  "api/evidence-lane.json": evidenceLane(),
  "api/payer-rules.json": payerRules(),
